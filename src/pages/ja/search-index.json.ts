...
import { buildSearchIndex, type Chapters, type Credits, type LangData, type LangI18n } from "../../lib/search-builder";
...
export async function GET() {
  ...
  return new Response(JSON.stringify(indexByLang[lang]), { headers: { "Content-Type": "application/json; charset=utf-8" } });
}
