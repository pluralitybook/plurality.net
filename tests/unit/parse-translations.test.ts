...
describe('parseGithubBase', () => {
  ...
  test('handles nested path prefixes', () => {
    expect(parseGithubBase('https://raw.githubusercontent.com/a/b/main/contents/nested/')).toEqual({
      owner: 'a',
      repo: 'b',
      branch: 'main',
  ...
  test('tolerates missing trailing slash', () => {
    expect(parseGithubBase('https://raw.githubusercontent.com/a/b/main/contents')).toEqual({
      owner: 'a',
      repo: 'b',
      branch: 'main',
      pathPrefix: 'contents',
  ...
  test('supports non-main branches', () => {
    expect(parseGithubBase('https://raw.githubusercontent.com/a/b/develop/foo/')).toMatchObject({
      branch: 'develop',
      pathPrefix: 'foo',
    });
  });
